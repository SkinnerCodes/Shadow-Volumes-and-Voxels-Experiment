...
public class Quad {
    ...
    public static void renderShadowVolume(int instanceBuffer, int instanceOffset, int instances)
    {
        ...
        glVertexAttribPointer(8, 4, GL_UNSIGNED_BYTE, true, quadInstanceSize, 4*5 + instanceOffset );
        glVertexAttribPointer(9, 1, GL_UNSIGNED_BYTE, true, quadInstanceSize, 4*6 + instanceOffset );
        glDrawElementsInstanced(GL_POINTS, 1, GL_UNSIGNED_BYTE, eleoffset, instances);
        //glDrawArrays(GL_POINTS, instanceOffset / quadInstanceSize, instances);
        glBindBuffer(GL_ARRAY_BUFFER, 0);
